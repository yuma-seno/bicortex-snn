...
従来の深層学習（誤差逆伝播法）に依存せず、**「意味的共鳴ゲーティング (Semantic Resonance Gating)」** と呼ばれる独自の局所則を用いることで、低演算コストでの文脈適応の実現を目指します。
...
* **Trace & Link (痕跡と結合):** 記憶野は、思考野から送られてきた情報を一時的に保持（Trace）し、報酬信号に基づいてそれらを結びつけます（Link）。
